"""
Modulo de inteligencia artificial de Evelyn.

Por favor si no tiene conocimientos de IA se recomienda no modificar este archivo ya que
este modulo es indispensable. Aqui se encuentran redes neuronales que se encargan del 
NLP (Natural Processing Language) y modificarlas causarían serios daños al nucleo del programa. 
...
# error
training_data.append({"class":"error", "sentence":""})
words = []
classes = []
documents = []
ignore_words = ['?']
...
for doc in documents:
    ...
    bag = []
    # list of tokenized wors for the pattern
    pattern_words = doc[0]
    # stem each word
...
print ("Listo. (processing time:", elapsed_time, "seconds)")
...
def IA(command):
  data_save = classify(command, show_details=False)
  return data_save
